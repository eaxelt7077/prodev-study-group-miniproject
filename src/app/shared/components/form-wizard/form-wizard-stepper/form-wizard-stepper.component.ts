...
import { Status, stepmodel } from './step-model';
...
export class FormWizardStepperComponent extends stepmodel implements OnInit {
  itemLength: number;
  ...
  @Output() public stateChange = new EventEmitter<{activeIndex: number; activeStep: ProgressStepComponent;}>();
